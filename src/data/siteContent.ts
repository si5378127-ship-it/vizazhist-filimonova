...
export const site = {
  ...
  title: "Макияж в Твери — визажист Елена Филимонова",
  description:
    "Визажист Елена Филимонова в Твери. Макияж для мероприятий, свадеб, съёмок и особых случаев. Стоимость макияжа — 3 000 ₽. Онлайн-запись.",
